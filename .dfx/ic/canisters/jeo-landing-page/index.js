...
import { idlFactory } from './jeo-landing-page.did.js';
export { idlFactory } from './jeo-landing-page.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_JEO_LANDING_PAGE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./jeo-landing-page.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the jeo-landing-page canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./jeo-landing-page.did.js")._SERVICE>}
 */
export const jeo_landing_page = createActor(canisterId);
